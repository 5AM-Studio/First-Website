...
function my_custom_login_logo() {
    echo '<style type="text/css">
        .login h1 a {
            background-image:url("http://www.5am.website/wp-content/uploads/2019/02/LOGO150X150.png") !important;
        height: 128px; //修改为图片的高度
        width: 128px; //修改为图标的宽度
        -webkit-background-size: 128px; //修改为图标的宽度
        background-size: 128px; //修改为图标的宽度
        }
    </style>';
}
