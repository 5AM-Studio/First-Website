...
<head>
	...
	<meta name="google-site-verification" content="hWMpsWv6fbaNmcXlohFqqdNSFglHZwOohkuUFpHK4yM" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-134947945-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-134947945-1');
</script>
